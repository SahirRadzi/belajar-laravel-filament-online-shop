        ...
        <div class="p-6">
            ...
            <div class="text-center mb-8 pt-8">
                <div class="w-24 h-24 bg-gradient-to-br from-primary to-secondary rounded-3xl mx-auto flex items-center justify-center mb-6">
                    <img src="https://i.ibb.co/N7Kzn2Z/star-moon-2025.png" alt="Logo" class="w-14 h-14 brightness-0 invert">
                </div>
                <h1 class="text-2xl font-bold text-gray-800 mb-2">Welcome BB 2025</h1>
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input
                           ...
                           class="w-full px-4 py-3 rounded-xl border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary sm:text-sm">
                    </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <div class="mt-1 relative">
                            ...
                            id="password"
                            class="appearance-none block w-full px-4 py-3 rounded-xl border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary sm:text-sm"
