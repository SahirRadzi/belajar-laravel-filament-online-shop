<div class="max-w-[480px] mx-auto bg-white min-h-screen relative shadow-lg">
    ...
    <div class="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] bg-white z-50">
        <div class="flex items-center h-16 px-4 border-b border-gray-100">
            ...
            <h1 class="ml-2 text-lg font-medium">Profile</h1>
        </div>
    </div>
    ...
    <div class="pt-16">
        ...
        <div class="bg-gradient-to-br from-primary to-secondary p-6">
            <div class="flex items-center gap-4">
                ...
                <div class="text-white">
                    <h2 class="text-xl font-semibold">Sahir Radzi</h2>
                    <p class="text-white/80">sahir.radzi@gmail.com</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-4 space-y-4">
            ...
            <!-- Preferences -->
            <div class="space-y-2">
                <h3 class="text-sm font-medium text-gray-500">Preference</h3>
                <div class="space-y-1">
                    <a href="#" class="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100">
                        <div class="flex items-center gap-3">
            ...
            <!-- Other Settings -->
            <div class="space-y-2">
                <h3 class="text-sm font-medium text-gray-500">Others</h3>
                <div class="space-y-1">
                    <a href="#" class="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100">
                        <div class="flex items-center gap-3">
